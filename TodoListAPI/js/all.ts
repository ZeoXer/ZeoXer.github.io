...
const regist_nickname = document.getElementById("regist-nickname")! as HTMLInputElement;
const regist_pwdRepeat = document.getElementById("regist-pwdRepeat")! as HTMLInputElement;
...
function formatCheck(
  ...
  email_warning: HTMLElement,
  pwd_warning: HTMLElement,
  isRegist:number = 0
) {
